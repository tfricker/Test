...
#tm_scale_bar(position = c("RIGHT", "BOTTOM")) +
#tm_compass(position = c("right", "bottom")) +
tm_layout(main.title = "C",bg.color="white", attr.outside=TRUE)
```
...
tm_layout(main.title = "A",bg.color="white", attr.outside=TRUE)
```
...
#tm_scale_bar(position = c("RIGHT", "BOTTOM")) +
#tm_compass(position = c("left", "bottom")) +
tm_layout(main.title = "B",bg.color="white", attr.outside = TRUE)
```

Smithville, MS/Shottville, AL map
```{r}
Region <- states %>%
  filter(iso_3166_2 %in% c("GA", "AL", "MS", "SC", "TN", "NC"))
Region2 <- states %>%
...
tm_shape(Shottsville) +
  tm_dots(col = "#1b7837", size = .65, alpha = 0.6) +
#tm_scale_bar(position = c("RIGHT", "BOTTOM")) +
#tm_compass(position = c("right", "bottom")) +
tm_layout(main.title = "D", bg.color="white", attr.outside=TRUE)
```

Plot together
```{r}
tmap_arrange(A, B, C, D, ncol = 2)
```

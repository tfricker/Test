...
map = get_googlemap("camilla georgia", zoom = 13, maptype = "satellite")
...
ggmap(map) + 
  ...
  geom_sf(data = cam_3857$geometry, inherit.aes = FALSE, alpha =.3) +
  geom_sf(data = cam2_3857$geometry, inherit.aes = FALSE, alpha =.3) +
  labs(x = NULL, y = NULL) +
  theme(legend.position = "none",
